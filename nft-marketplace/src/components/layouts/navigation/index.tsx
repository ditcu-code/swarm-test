...
export default function Navigation() {
  return (
    <header className="w-full bg-(--color-background) border border-amber-50">
      <div className="mx-[50px] h-[100px] flex items-center justify-between">
        ...
        <div className="flex items-center gap-2.5">
          ...
          <Link
            to="/home"
            className="font-semibold! px-[30px] inline-flex items-center gap-3 h-[60px] bg-(--color-primary) text-white! py-3 rounded-2xl shadow-sm hover:opacity-95 transition select-none"
          >
